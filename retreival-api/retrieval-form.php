...
function getPayment($token)
{
    ...
    $url = API_BASE_URL . 'payment/search?order_id=' . $payment_id;
        ...
        <div class="col-lg-12">
            <form action="retrieval-form" method="get">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="order_id" name="order_id" placeholder="" required value="<?php echo isset($_GET['id']) ? $_GET['id'] : (isset($_GET['order_id']) ? $_GET['order_id'] : '') ?>">
        ...
        <div class="col-lg-12">
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    <a class="nav-item nav-link active " id="nav-json-tab" data-toggle="tab" href="#nav-json" role="tab" aria-controls="nav-profile" aria-selected="false">JSON</a>
                    <a class="nav-item nav-link" id="nav-html-tab" data-toggle="tab" href="#nav-html" role="tab" aria-controls="nav-home" aria-selected="true">HTML</a>
                </div>
            </nav>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody id="modal_tbody">
                            ...
                            ?>
                                <tr>
                                    <td colspan="8">
                                        <p class="text-center"><em><?php echo $msg ?></em></p>
                                    </td>
                                </tr>
                                <?php
                            } else {
